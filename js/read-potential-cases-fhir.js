...
(async () => {
  ...
  await fs.writeFile("sick-sinus-syndrome-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("sick-sinus-syndrome-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
